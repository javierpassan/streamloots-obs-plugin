...
function(_check_dependencies)
  ...
  foreach(dependency IN LISTS dependencies_list)
    ...
    if(dependency STREQUAL obs-studio OR dependency STREQUAL asio OR dependency STREQUAL websocketpp)
      set(url ${url}/${file})
    else()
    ...
    if(NOT EXISTS "${dependencies_dir}/${file}")
      ...
      if(hash_length EQUAL 64)
        set(hash_algorithm SHA256)
      elseif(hash_length EQUAL 40)
        set(hash_algorithm SHA1)
      else()
        message(FATAL_ERROR "Unsupported hash length (${hash_length}) for dependency '${dependency}'")
      endif()

      file(DOWNLOAD "${url}" "${dependencies_dir}/${file}" STATUS download_status EXPECTED_HASH ${hash_algorithm}=${hash})
    ...
    elseif(dependency STREQUAL asio)
      set(ASIO_DIR "${dependencies_dir}/${destination}" CACHE PATH "ASIO source directory" FORCE)
    elseif(dependency STREQUAL websocketpp)
      set(WEBSOCKETPP_DIR "${dependencies_dir}/${destination}" CACHE PATH "WebSocket++ source directory" FORCE)
    endif()
